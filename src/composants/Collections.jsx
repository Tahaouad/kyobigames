            ...
            {collections.map((collection, index) => (
                <div key={index} id={`Collections-${index}`} className="d-flex align-items-center justify-content-center" style={{ backgroundColor: '#000123', paddingBottom: '30px', minHeight: '100vh' }}>
                        <div className='container mt-5 '>
                            <div className="row ">
                                <div className="col-md-6 my-auto p-2">
                                    <img className='mx-auto' src={require(`../images/${collection.image}`)} alt="" style={{ width: '90%', height: 'auto' }} />
                                </div>
                                <div className="col-md-6 my-auto ">
                                    <div>
                                        ...
                                        <Link to={`Collections-${index + 1}`} smooth={true} duration={700}>
                                            <a href="#" className="btn text-light rounded-pill px-3 py-2" style={{ backgroundColor: "#FF0F7B", margin: '0' }}>
